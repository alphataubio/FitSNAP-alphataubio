...
class ParallelTools():
    ...
    def _comm_split(self):
        ...
        is_multinode_testing = "ON" if self.multinode_testing else "OFF"
        self.single_print(
            f"----------------------------------------------------------------\n"
            f"  PARALLEL TOOLS                                                \n"
            f"                                                                \n"
            f"    {self._size} ranks, {self._number_of_nodes} node(s), {self._sub_size} ranks/node\n"
            f"    multinode_testing {is_multinode_testing}                    \n"
        )
