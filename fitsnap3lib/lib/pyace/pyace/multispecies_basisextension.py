...
from pyace import ACEBBasisSet, BBasisConfiguration, BBasisFunctionSpecification, BBasisFunctionsSpecificationBlock
...
def create_multispecies_basis_config(potential_config: Dict,
    ...
    if unif_mus_ns_to_lsLScomb_dict is None:
        with resources.files('pyace').joinpath(path).open('rb') as f:
